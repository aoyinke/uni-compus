<template>
    <view class="page">
		<uni-nav-bar left-icon="back" title="问题反馈" @clickLeft="clickLeft"></uni-nav-bar>
		...
		<view class="submitBottom">
			<uniCompusButton content="提交" background="#FFC312" width="100" @tap.native="send"></uniCompusButton>
		</view>
