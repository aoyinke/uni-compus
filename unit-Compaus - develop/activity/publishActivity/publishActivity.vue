		...
		<view class="main">
			...
			<view class="choosedGroup" v-show="groupId">
				<view class="choosedGroup-item">
					...
					<text>{{ userChoosedGroup.groupName }}</text>
				</view>
			</view>
		</view>
					...
					<view class="uni-tab-bar">
						...
						<scroll-view scroll-y="true" class="list" :style="{ height: scrollHeight + 'px' }">
							<view class="group-list">
								<view class="group-list-item" v-for="(group, idx) in userJoinedGroup" :key="idx">
									<view class="group-list-item-left">
										<kp-avatar :image="group.logo" size="large" mode="aspectFill" />
										<text>{{ group.groupName }}</text>
									</view>
									<view class="group-list-item-right" @click="chooseGroup(group.groupId, group)"><text class="eosfont">&#xe715;</text></view>
								</view>
							</view>
						</scroll-view>
					</view>
