<template>
	<view class="con" :style="{'margin-bottom':btm}">
		<image v-if="picmode" :src="backgroundImage" :style="{height:bgh,'margin-top':'197px'}" class="back"></image>
		<view v-else="" :style="{height:bgh,'background-color':backgroundColor,'margin-top':'197px'}" class="back"></view>
