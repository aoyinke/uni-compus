<template>
	<view class="contaier">
		<view class="peopleFall" :style="{ height: peopleViewHeight }">
			...
			>
				<go-detail detailUrl="/groupInfo/groupDetail/groupDetail">
					<image class="peopleFall-item-img" :src="item.coverImg" mode="" :style="{ height: imgStyle[index].height }"></image>
				</go-detail>
				<view class="peopleFall-item-desc">
					<go-detail detailUrl="/groupInfo/groupDetail/groupDetail">
						
						<text class="text-line-2">{{ item.intro }}</text>
