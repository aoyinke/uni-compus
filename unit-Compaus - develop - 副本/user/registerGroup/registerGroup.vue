	...
	<view>
		...
		<view class="main">
			<view class="uni-list-cell uni-list-cell-pd changeTaskName">
				...
				<input type="text" v-model="groupInfo.college" maxlength="20"/>
			</view>
			<view class="uni-list-cell uni-list-cell-pd changeTaskName">
				<view class="uni-list-cell-db" style="font-weight: 500;">小组的名称</view>
				<input type="text" v-model="groupInfo.groupName" maxlength="20"/>
			</view>
			...
			<view class="uni-list-cell uni-list-cell-pd changeTaskName" @click="chooseLogo">
				<view class="uni-list-cell-db" style="font-weight: 500;">小组logo</view>
