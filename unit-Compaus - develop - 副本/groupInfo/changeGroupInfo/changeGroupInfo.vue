<template>
	<view>
		...
		<view class="uni-list-cell uni-list-cell-pd">
			...
			<input type="text" v-model="groupInfo.groupName" style="text-align: right;" maxlength=20/>
		</view>
		<view class="uni-list-cell uni-list-cell-pd">
			<view class="uni-list-cell-db">所属学校</view>
			<input type="text" v-model="groupInfo.college" style="text-align: right;" maxlength=20/>
		</view>
		...
		<view class="uni-list-cell uni-list-cell-pd"><view class="uni-list-cell-db">联系方式</view></view>
		<view class="group-specailActivity"><textarea v-model="groupInfo.concat" placeholder="编辑联系方式吧~" /></view>
		...
		<view class="group-tags">
			<view v-for="(row, index) in groupInfo.tags" :key="index" class="tag-wrap">
				<kp-tag  class="detail-labels" type="primary" shape="circle">
					<text>{{row}}</text>
				</kp-tag>
