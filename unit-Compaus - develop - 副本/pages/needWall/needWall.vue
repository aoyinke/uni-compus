<template>
	<view>
		...
		<view class="uni-tab-bar">
			<swiper :current="currentIndex" class="swiper-box" :style="{ height: needHeight + 'px' }" @change="changeCurrentIndex">
...
export default {
	...
	async onLoad() {
		...
		let needList = this.request(`v1/needWall/needList?currentPage=${1}&category=${100}`)
			.then(res => {
